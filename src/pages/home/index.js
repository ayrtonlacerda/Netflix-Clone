...
import { Creators as PMActions } from '../../store/ducks/popularmovie';
...
class HomePage extends Component {
  ...
  componentDidMount() {
    ...
    this.props.getPMrequest();
  }

  render() {
    console.tron.log('render')
    console.tron.log(this.props)
    console.tron.log(this.props.topratedM)
    console.tron.log(this.props.popularM)
    console.tron.log(this.props.popularM.data.results)
    //this.setState({ results2: this.props.topratedM })
    console.tron.log('results22')
    ...
    return (
      ...
      {this.props.topratedM.content && this.props.popularM.content ?
      <ScrollView>
        <Text style={styles.TitleTipes}>
          Melhores Filmes
        </Text>
        <ScrollView horizontal={true} style={styles.scroll}>
          {this.props.topratedM.data.results.map(movies =>
            <ScrollPoster
        ...
        <ScrollView horizontal={true} style={styles.scroll}>
          {this.props.popularM.data.data.map(movies =>
            <ScrollPoster
              key={movies.poster_path}
              poster={movies.poster_path}
              title={movies.title}
      ...
      : <ActivityIndicator size={22} color={'#cb1800'} style={styles.indicator} />}
...
const mapStateToProps = state => ({
  topratedM: state.theratedM,
  popularM: state.popularM,
});

const mapDispatchToprops = dispatch =>
  bindActionCreators({ ...TRMActions, ...PMActions }, dispatch);
